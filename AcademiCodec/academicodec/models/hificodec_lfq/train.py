...
from academicodec.models.hificodec.meldataset import MelDataset, mel_spectrogram
from academicodec.models.hificodec_lfq.meldataset import get_dataset_filelist
...
def train(rank, a, h):
    ...
    print("*"*100)
    print("load hifi-codec checkpoint for generator and encoder")
    cp_g = "/home/cjs/code/AcademiCodec/egs/HiFi-Codec-16k-320d/checkpoint/HiFi-Codec-16k-320d-large-universal"
    ...
    #     itertools.chain(quantizer.parameters()),
    #     h.learning_rate,
        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.validation_interval == 0 and steps != 0:
                    ...
                    val_err_tot = 0
                    with torch.no_grad():
                        for j, batch in enumerate(tqdm.tqdm(validation_loader)):
                            x, y, _, y_mel = batch
